...
description: Use for React performance and best practices from Vercel. Optimization guidelines. Triggers on: react best practices, react performance, vercel react.
version: 1.0.0
detect: ["react", "next"]
---
